          ...
          <div className="lg:col-span-9 bg-white/[0.015] border border-white/[0.06] rounded-2xl p-6 md:p-10 backdrop-blur-md shadow-2xl space-y-10 text-slate-350 leading-relaxed font-sans text-xs md:text-sm">
            ...
            <section id="disclaimer" className="space-y-4 scroll-mt-32">
              ...
              <div className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-xl text-xs space-y-2 text-amber-400 font-semibold mb-4">
                ...
                <p>
                  ...
                  qualitative action playbooks generated by RetentIQ's Scikit-Learn classifiers and
                  GROQ LLM API are mathematical risk projections.
                </p>
                <p>
            ...
            <section id="prohibited" className="space-y-4 scroll-mt-32">
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>
                  Reverse-engineer, decompile, or copy the structure of our Scikit-Learn Gradient
                  Boosting churn risk models or FastAPI prediction pipelines.
                </li>
