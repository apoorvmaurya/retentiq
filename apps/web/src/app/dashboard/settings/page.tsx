    ...
    <div className="space-y-8 text-slate-100">
      ...
      <div>
        ...
        <p className="text-sm text-slate-400 font-medium mt-0.5">
          Manage user profile configurations, domains, and security credentials.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="glass-panel rounded-xl p-6 lg:col-span-2 space-y-6 h-fit">
            ...
            <form onSubmit={handleSaveProfile} className="space-y-6">
              <div className="flex flex-col sm:flex-row items-center gap-6">
                ...
                <div className="relative group shrink-0">
                  {avatarUrl ? (
                    ...
                    <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-[#0F172A] to-[#1E293B] border-2 border-cyan-500/20 text-cyan-400 font-extrabold text-2xl flex items-center justify-center shadow-inner">
              ...
              <div className="flex items-center justify-between border-t border-slate-800 pt-4">
                <p className="text-[10px] text-slate-400 font-semibold max-w-md">
                  Personal profile details are synced directly across CS notification channels and
                  active workspaces.
                </p>
                ...
                <div className="flex items-center gap-3">
                  {saveStatus && (
                    <span
                      className={`text-xs font-bold ${saveStatus.includes('successfully') ? 'text-emerald-400' : 'text-rose-400'} animate-pulse`}
                    >
                      {saveStatus}
                    </span>
                  )}
          ...
          <div className="glass-panel rounded-xl p-6 space-y-6 h-fit">
            <h4 className="font-bold text-white text-base border-b border-slate-800 pb-3 flex items-center gap-2">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 text-slate-200">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-slate-400">
                    Increase account protection with secondary verifications.
                  </span>
                </div>
                <button className="ml-auto btn-secondary !py-1.5 !px-3">Enable</button>
              </div>

              <div className="flex items-center gap-3 text-slate-200 border-t border-slate-800/60 pt-4">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-slate-400">
                    Dispatch health updates and score transitions directly to API endpoints.
                  </span>
                </div>
                <button className="ml-auto btn-secondary !py-1.5 !px-3">Configure</button>
              </div>
              ...
              <div className="flex items-center gap-3 text-slate-200 border-t border-slate-800/60 pt-4">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-slate-400">
                    Customize frequency and severity rules for CS notifications.
                  </span>
                </div>
                <button className="ml-auto btn-secondary !py-1.5 !px-3">Manage</button>
              </div>
            </div>
          </div>
        </div>
